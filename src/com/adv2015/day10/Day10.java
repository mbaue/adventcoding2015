 ...
 * ake the previous value, and replace each run of digits (like 111) with the number of digits (3) followed by the digit itself (1).
 *
 * For example:
 *
...
public class Day10 {
    public static void main(String[] args) {
        ...
        String in = "3113322113";
        String newIn;

        for (int i = 1; i <= 50; i++) {
            newIn = LookAndSay(in);
            System.out.println(newIn + ", delka = " + newIn.length());
            in = newIn;
        }
